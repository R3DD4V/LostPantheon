    ...
    public static void registerClientTickEvent() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (Ability1.wasPressed()) {
                ...
                ((cookingKnife) modItems.DemonicCookingKnife).getAnimatableInstanceCache().getManagerForId(0).tryTriggerAnimation("controller", "animation.demonic_cooking_knife.idle");
            }
        });
    }
}
